...
namespace StateMachineAI
{
    ...
    public class AITester : StatefulObjectBase<AITester, AIState_Type>, IDamageable
    {
        ...
        [Header("中ボス判定"), Tooltip("これがtrueの場合、BossObjectDestroyerによって検知されます")]
        public bool m_IsBoss = false;

        [Header("ラスボス判定"), Tooltip("これがtrueの場合、FinalBossObjectDestroyerによって検知されます")]
        ...
        [Header("HPバーUI"), Tooltip("EnemyHPUnitのPrefab")]
