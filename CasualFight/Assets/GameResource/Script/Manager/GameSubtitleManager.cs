...
public class GameSubtitleManager : MonoBehaviour
{
    ...
    [Header("UI References"), Header("フェードイン・アウト用のCanvasGroup"), SerializeField]
    private CanvasGroup m_CanvasGroup;
    [Header("話者名を表示するテキスト"), SerializeField]
    private Text m_NameText;
    [Header("メッセージ本文を表示するテキスト"), SerializeField]
    private Text m_MessageText;

    [Header("Settings"), Header("1秒間に表示する文字数（Characters Per Second）"), SerializeField]
    private int m_Cps = 20;
