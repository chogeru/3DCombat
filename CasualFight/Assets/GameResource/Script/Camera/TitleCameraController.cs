...
public class TitleCameraController : MonoBehaviour
{
    ...
    CinemachineBlendListCamera m_BlendListCamera;
    [Header("移動先（到達判定用）"), SerializeField]
    CinemachineVirtualCamera m_Vcam2;

    [Header("Target"), SerializeField]
    GameObject m_CameraLookTarget;

    [Header("Parallax"), Tooltip("遷移完了後に有効化するMouseLookParallaxコンポーネント"), SerializeField]
    MouseLookParallax m_MouseLookParallax;
