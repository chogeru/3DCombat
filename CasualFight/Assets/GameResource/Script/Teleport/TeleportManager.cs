...
public class TeleportManager : MonoBehaviour
{
    ...
    [Header("UI設定"), Header("UI全体の親"), SerializeField]
    GameObject m_TeleportUIRoot;
    [Header("プレビュー画像表示用Image"), SerializeField]
    Image m_TeleportPointImage;
    [Header("決定ボタン"), SerializeField]
    Button m_TeleportOKButton;
    [Header("各地点のボタン等にあるテキストのリスト"), SerializeField]
    List<Text> m_PointNameTexts;
    [Header("未開放時に表示するテキスト"), SerializeField]
    Text m_NotYetOpenText;
